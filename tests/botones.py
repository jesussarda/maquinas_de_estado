...
imagen_panel = pygame.image.load("./img/panel.png")                                 # dibujo del panel

imagen_boton = pygame.image.load("./img/button.png")                                # dibujo del botón rectangular
imagen_boton_pressed = pygame.image.load("./img/buttonPressed.png")

imagen_boton_cuadro = pygame.image.load("./img/buttonSquare.png")                   # dibujo del botón cuadrado
imagen_boton_cuadro_pressed = pygame.image.load("./img/buttonSquarePressed.png")

imagen_text = pygame.image.load("./img/panelInset_brown.png")                       # dibujo del área de salida de números
