...
#------------------------------------------------------------------------------ 
#    Traslacióna lo largo de un vector
...
#------------------------------------------------------------------------------ 
#    Rotación alrededor de un vector
...
class Wireframe:
    ...
    #--------------------------------------------------------------------------
    #    Añade nodos o vértice del modelo
    ...
    #--------------------------------------------------------------------------
    #    Añade lados o borde  del modelo
    ...
    #--------------------------------------------------------------------------
    #    Añade cara o superficie del modelo

    def addFaces(self, face_list, face_colour=(255,255,255)):
        """ 
        Add faces as a list of . 
        """
     ...
     #--------------------------------------------------------------------------
     #    Imprime en consola lista de nodos, bordes y/o caras del modelo
    ...
    def output(self):
     ...
     #--------------------------------------------------------------------------
     #    Improme  en consola lista de nodos
    ...
    def outputNodes(self):
     ...
     #--------------------------------------------------------------------------
     #     Improme  en consola lista de bordes o lados
    ...
    def outputEdges(self):
     ...
     #--------------------------------------------------------------------------
     #     Improme  en consola lista de caras
    ...
    def outputFaces(self):
        ...
        for i, nodes in enumerate(self.faces):
            txt= ", ".join(["%d" % str(n) for n in nodes])
            print ("   %d: (%s)" % (i, txt))
            #print ("   %d: (%s)" % (i, ", ".join(["%d" % n for n in nodes])))
    
     #--------------------------------------------------------------------------
     #    Transforma matriz de nodos  es decir traslada, rota, escala,...
    ...
    def transform(self, transformation_matrix):
     ...
     #--------------------------------------------------------------------------
     #    Busca el centro geométrico del modelo
...
#===============================================================================
#     Crea una librería a partir de los parámetros del modelo para manipularlos
#     juntos
#===============================================================================
...
class WireframeGroup:
    ...
    def output(self):
     ...
     #--------------------------------------------------------------------------
     #    Imprime nodos o vértoces del modelo
    ...
    def outputEdges(self):
     ...
     #--------------------------------------------------------------------------
     #    Encuentra centro geométrico (punto medio) del modelo
    ...
    def findCentre(self):
     ...
     #--------------------------------------------------------------------------
     #    Transforma segun matriz de transformación pasada como parámetro
